...
import { useEffect, useState, type FC, forwardRef, ElementRef, ComponentPropsWithoutRef, PropsWithChildren } from "react";
import { CircleXIcon, FileIcon, CameraIcon } from "lucide-react";
import {
  AttachmentPrimitive,
  ComposerPrimitive,
  MessagePrimitive,
...
const AttachmentThumb: FC = () => {
  ...
  const src = useAttachmentSrc();
  const isCameraPhoto = file?.name === "photo.png";
  return (
    <div className="relative">
      ...
      {isCameraPhoto && (
        <span className="absolute bottom-0 right-0 bg-white rounded-full p-0.5 shadow border">
...
export const ComposerAddAttachment = forwardRef<
  ElementRef<typeof TooltipIconButton>,
  ComponentPropsWithoutRef<typeof TooltipIconButton>
>(({ tooltip = "Add Attachment", ...props }, ref) => {
  return (
