...
synthesizer.generate_goldens_from_contexts(contexts=[
    # Wine contexts
    ["Pinot Noir is a versatile red wine that pairs well with many foods.", "Our selection includes Pinot Noirs from California, Oregon, and New Zealand."],
    ["Italian wines like Chianti are known for their food-friendly acidity.", "We offer both entry-level and premium Chianti options."],
    ["California wines offer excellent value and consistent quality.", "Our California selection includes Pinot Noir, Merlot, and red blends."],
    
    # Beer contexts
    ["IPAs are known for their hoppy, bitter flavor profile.", "We have several IPAs on tap with different hop characteristics."],
    ["Ciders offer a refreshing alternative to beer and wine.", "Our ciders range from sweet to dry with various fruit flavors."],
    ["Pilsners are light, crisp lagers perfect for warm weather.", "We serve traditional Czech-style pilsners."],
    
    # General beverage knowledge
    ["Alcohol content affects both flavor and serving size.", "Our beers range from 4.8% to 8% ABV."],
    ["Glass size affects the drinking experience.", "We serve beers in 12oz and 16oz pours."],
    ["Price points vary by quality and region.", "We offer options from $10 to $70 per bottle."],
    
    # Food pairing contexts
    ["Red wines typically pair well with red meats.", "Our steak selection works well with bold reds."],
    ["Light beers complement casual fare.", "Our burger menu has several beer pairing options."],
    ["Dessert wines should be sweeter than the dessert.", "We have several options for after-dinner drinks."]
])
